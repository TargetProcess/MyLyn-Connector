...
/**
 * AuthScheme that delegates the work of reading and writing NTLM messages to the JCIFS implementation.
 *
...
public class JcifsNtlmScheme implements AuthScheme {
	 ...
	 */
	public JcifsNtlmScheme(final String challenge) throws MalformedChallengeException {
		super();
	...
	public void processChallenge(final String challenge) throws MalformedChallengeException {
		...
		if (i != -1) {
			...
			ntlmchallenge = s.trim();
			state = TYPE2_MSG_RECEIVED;
		} else {
			ntlmchallenge = "";
			state = state == UNINITIATED ? INITIATED : FAILED;
		}
	}
	 ...
	 *
	 * @return true if Basic authorization has been processed, false otherwise.
	 *
	 * @since 3.0
	 */
	...
	public String authenticate(Credentials credentials, HttpMethod method) throws AuthenticationException {
		...
		if (state == INITIATED) {
		...
		} else if (state == TYPE2_MSG_RECEIVED) {
			byte[] msg2Bytes = Base64.decodeBase64(EncodingUtil.getBytes(ntlmchallenge, method.getParams()
			...
			try {
				...
				Type3Message msg3 = new Type3Message(msg2, ntcredentials.getPassword(), ntcredentials.getDomain(),
						ntcredentials.getUserName(), ntcredentials.getHost(), 0);
