...
public class TargetProcessUiPlugin extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		TargetProcessRepositoryConnector targetProcessConnector = (TargetProcessRepositoryConnector) TasksUi.getRepositoryManager()
				.getRepositoryConnector(TargetProcessCorePlugin.CONNECTOR_KIND);
